...
public class GreenplumDatabaseDialectTest extends BaseDialectTest<GreenplumDatabaseDialect> {

  @Override
  protected GreenplumDatabaseDialect createDialect() {
    return new  GreenplumDatabaseDialect(sourceConfigWithUrl("jdbc:postgresql://something"));
  }
